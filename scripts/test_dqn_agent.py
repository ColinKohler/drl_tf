...
def main():
    ...
    envarg.add_argument('--_id', dest='_id', default=None)
    ...
    envarg.add_argument('--epochs', dest='epochs', type=int, default=10,
                        help='How many epochs to run')
    envarg.add_argument('--train_steps', dest='train_steps', type=int, default=0,
                        help='Number of training steps per epoch.')
    envarg.add_argument('--test_eps', dest='test_eps', type=int, default=10,
    ...
    envarg.add_argument('--random_start', dest='random_start', default=False,
                        help='Start each episode with a random state.')
    envarg.add_argument('--load_model', dest='load_model', default=True,
    ...
    agentarg.add_argument('--double_q', dest='double_q', default=False,
